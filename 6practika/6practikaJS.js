...
//отображаем счётчик количества товаров в корзине и добавляем товар в корзину let addBtns = document.querySelectorAll(".featuredAddToCart"); addBtns.forEach(addBtn => {
